...
#define MIN_POT_CHANGE 5 // locked pot reading must change by this in order to register
#define MIN_COUNTS 5  // unlocked pot must change by this in order to register
